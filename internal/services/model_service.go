...
func (m *ModelService) GetModelCatalog() ([]neurotypes.ModelCatalogEntry, error) {
	if !m.initialized {
		return nil, fmt.Errorf("model service not initialized")
	}
...
func (m *ModelService) GetModelCatalogByProvider(provider string) ([]neurotypes.ModelCatalogEntry, error) {
	if !m.initialized {
		return nil, fmt.Errorf("model service not initialized")
	}
...
func (m *ModelService) SearchModelCatalog(query string) ([]neurotypes.ModelCatalogEntry, error) {
...
func (m *ModelService) GetSupportedProviders() []string {
	return []string{"anthropic", "openai"}
}

// loadProviderCatalog loads and parses a provider's model catalog from embedded YAML data.
func (m *ModelService) loadProviderCatalog(providerName string, data []byte) ([]neurotypes.ModelCatalogEntry, error) {
