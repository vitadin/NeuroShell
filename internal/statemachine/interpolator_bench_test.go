...
func BenchmarkCoreInterpolator_MultipleVariables(b *testing.B) {
	...
	_ = ctx.SetVariable("user", "Alice")
	_ = ctx.SetVariable("action", "running")
	_ = ctx.SetVariable("object", "tests")
...
func BenchmarkCoreInterpolator_NestedVariables(b *testing.B) {
	...
	_ = ctx.SetVariable("c", "final_value")
	text := "Result: ${a}"
...
func BenchmarkCoreInterpolator_DeepNesting(b *testing.B) {
	...
	_ = ctx.SetVariable("var1", "${var2}")
	_ = ctx.SetVariable("var2", "${var3}")
	_ = ctx.SetVariable("var3", "${var4}")
	_ = ctx.SetVariable("var4", "${var5}")
	_ = ctx.SetVariable("var5", "${var6}")
	_ = ctx.SetVariable("var6", "${var7}")
	_ = ctx.SetVariable("var7", "${var8}")
	_ = ctx.SetVariable("var8", "deep_value")
	text := "Deep: ${var1}"
...
func BenchmarkCoreInterpolator_LargeText(b *testing.B) {
	...
	_ = ctx.SetVariable("service", "NeuroShell")
	_ = ctx.SetVariable("version", "1.0.0")
...
func BenchmarkCoreInterpolator_InterpolateCommandLine(b *testing.B) {
	...
	_ = ctx.SetVariable("message", "Hello World")
...
func BenchmarkCoreInterpolator_MixedContent(b *testing.B) {
	...
	_ = ctx.SetVariable("user", "developer")
	_ = ctx.SetVariable("project", "NeuroShell")
	_ = ctx.SetVariable("task", "interpolation")
...
func BenchmarkCoreInterpolator_LargeTextExpansion(b *testing.B) {
	...
	_ = ctx.SetVariable("var", "expanded_value")
...
func BenchmarkCoreInterpolator_VeryDeepNesting(b *testing.B) {
	...
	_ = ctx.SetVariable("level3", "level4")
	_ = ctx.SetVariable("level4", "deep_value")
	text := "${${${${level1}}}}"
